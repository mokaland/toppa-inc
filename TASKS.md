...
| Q1-T4 | フロントエンドUI改善 | Tech Lead (マルコ) | 2026-03-07 | 分割 | 具体的サブタスクは以下を参照 |
| Q1-T4.1 | チャットUI改善 (`ChatWindow.tsx`) | Tech Lead (マルコ) | 2026-02-25 | 未着手 | ローディング・エラー表示、スクロール追従機能 |
