...
| Q1-T4.2 | CSVアップロード機能強化 (`CsvUpload.tsx`) | Tech Lead (マルコ) | 2026-02-28 | 未着手 | **最優先。本日中の着手を強く指示。** ファイルサイズ上限(5MB)表示、プログレスバー追加 |
...
2. **本日中に必ず `Q1-T4.2 CsvUpload.tsx` に着手せよ。** 計画の遅延は許容しない。
